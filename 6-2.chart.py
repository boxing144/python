...
st.write("melt를 통해 unpivot한 데이터:", df_melted)
...
chart = alt.Chart(df_melted, title="일별 팀 매출 비교").mark_bar().encode(
...
fig = px.pie(medal, values="gold", names="nation", title="올림픽 양궁 금메달 현황", hole=0.3) # 도넛차트, hole=0.3
